import { Scene, Vector2, Raycaster, Vector3, Geometry, LineSegments, LineBasicMaterial, Group, CubeTexture, RGBFormat, TextureLoader, MeshBasicMaterial, DoubleSide, MeshFaceMaterial, CubeGeometry, Mesh, Face3, PerspectiveCamera, MOUSE, EventDispatcher, Matrix4, Frustum, PlaneGeometry, PlaneBufferGeometry, CylinderGeometry, Quaternion, ShaderMaterial } from 'three';
...
var Cartesian = /** @class */ (function () {
    function Cartesian(options) {
        ...
        this._y = 0;
        this._z = 0;
        this.addVectors = Vector3.prototype.addVectors;
        this.normalize = Vector3.prototype.normalize;
        this.length = Vector3.prototype.length;
        this.multiplyScalar = Vector3.prototype.multiplyScalar;
        this.divideScalar = Vector3.prototype.divideScalar;
        options = options || {};
        this._x = options.x || 0;
        this._y = options.y || 0;
    ...
    Cartesian.prototype.dot = function () {
        ...
        return (_a = Vector3.prototype.dot).call.apply(_a, [this].concat(args));
        var _a;
    };
    ...
    Cartesian.prototype.crossVectors = function () {
        ...
        return (_a = Vector3.prototype.crossVectors).call.apply(_a, [this].concat(args));
        var _a;
    };
...
var Pin = /** @class */ (function (_super) {
    ...
    function Pin(options) {
        ...
        var headGeometry = new CylinderGeometry(3, 3, 8, 8, 1);
        // Recalculate centroid of mesh offset by 8
        for (var i = 0, len = headGeometry.vertices.length; i < len; i++) {
            headGeometry.vertices[i].y += 8;
        }
        _this.head = new Mesh(headGeometry, new MeshBasicMaterial({ color: 0x3366ff, opacity: 0.8, transparent: true }));
        _this.head.name = 'Head';
        _this.head.pin = _this;
        var arrowGeometry = new CylinderGeometry(4, 0, 6, 6, 1);
        ...
        _this.arrow = new Mesh(arrowGeometry, new MeshBasicMaterial({ color: 0xffff00, opacity: 0.8, transparent: true }));
        ...
        _this.line = new LineSegments(lineGeometry, new LineBasicMaterial({ color: 0xffffff, linewidth: 3, transparent: true, opacity: 0.8 }));
    ...
    Object.defineProperty(Pin.prototype, "groundPosition", {
        get: function () { return new Vector3(this._position.x, 0, this._position.y); },
        set: function (p) {
            // Case position is a QtPositioning.coordiante
            if (p.longitude) {
                // TODO: Ground
...
var Polygon = /** @class */ (function (_super) {
    ...
    function Polygon(options) {
        ...
        _this.gridGenerateOffset = new Vector3();
        _this.pins = [];
        _this.grids = [];
        _this.angles = [];
        _this.lines = [];
    ...
    Polygon.prototype.addPin = function (position, height) {
        ...
        if (this.pins.length > 1) {
            ...
            var line = new LineSegments(lineGeometry, new LineBasicMaterial({ color: 0xffffff, linewidth: 3, transparent: true, opacity: 0.6 }));
            this.lines.push(line);
            this._map.scene.add(line);
            if (!this._closeLine) {
                var lineGeometry_ = new Geometry();
                lineGeometry_.vertices.push(this.pins[index].head.position);
                lineGeometry_.vertices.push(this.pins[0].head.position);
                this._closeLine = new LineSegments(lineGeometry_, new LineBasicMaterial({ color: 0xffffff, linewidth: 3, transparent: true, opacity: 0.6 }));
    ...
    Polygon.prototype.generateGrid = function (type, gridSpace, angle, speed, minute) {
        ...
        this.grids.forEach(function (grid) {
            ...
            _this.gridMesh.add(new LineSegments(lineGeometry, new LineBasicMaterial({
...
var panStart$1 = new Vector2();
var picker$1 = new Raycaster();
var panEnd$1 = new Vector2();
var panDelta$1 = new Vector2();
var px$1 = new Vector3();
...
var Skybox = /** @class */ (function (_super) {
    ...
    function Skybox() {
        var _this = this;
        var skyboxTexture = new CubeTexture([]);
        skyboxTexture.format = RGBFormat;
        ...
        //     uniforms,
        // });
        _this = _super.call(this, new CubeGeometry(MapSettings.basePlaneDimension, MapSettings.basePlaneDimension, MapSettings.basePlaneDimension, 1, 1, 1), skyMaterial) || this;
...
var Vehicle = /** @class */ (function (_super) {
    ...
    function Vehicle(options) {
        var _this = _super.call(this) || this;
        _this._map = options.map;
        var headGeometry = new Geometry();
        var radius = 7.5;
        var x = radius * 2.0 / 3.0;
        var offset = 0; // radius / 3.0;
        headGeometry.vertices = [
            new Vector3(0.0, 0.0, 0.0 + offset),
            new Vector3(-x * Math.sqrt(3), x, x + offset),
            new Vector3(x * Math.sqrt(3), x, x + offset),
            new Vector3(0.0, x * 2.0 / 3.0, 0.0 + offset),
            new Vector3(0.0, 0.0, -2 * x + offset),
        ];
        headGeometry.faces = [
            new Face3(0, 2, 3),
            new Face3(0, 3, 1),
...
var OrbitConstraint = /** @class */ (function () {
    function OrbitConstraint(map, camera, targetDistance) {
        ...
        quat = quat.setFromUnitVectors(this.camera.up, new Vector3(0, 1, 0));
...
var screenPosition$1 = new Vector2();
var picker$2 = new Raycaster();
var px$2 = new Vector3();
...
var OrbitControls = /** @class */ (function (_super) {
    ...
    function OrbitControls(options) {
        ...
        // Mouse buttons
        _this.mouseButtons = { ORBIT: MOUSE.RIGHT, ZOOM: MOUSE.MIDDLE, PAN: MOUSE.LEFT };
        /// /////////
        // internals
        var scope = _this;
...
function computeTileVisibility(primitive, tile) {
    if (tile.z <= 10) {
        ...
        var matrix = new Matrix4().multiplyMatrices(camera.projectionMatrix, camera.matrixWorldInverse);
        var frustum = new Frustum().setFromMatrix(matrix);
...
var ImageDataLayer = /** @class */ (function (_super) {
    ...
    ImageDataLayer.prototype.processData = function (tile, data) {
        ...
        tile.material = new MeshBasicMaterial({
            map: data,
        });
...
var EPSG4326MapImageDataLayer = /** @class */ (function (_super) {
    ...
    EPSG4326MapImageDataLayer.prototype.processData = function (tile, data) {
        ...
        tile.material = new ShaderMaterial({
            uniforms: uniforms,
...
var STKTerrainDataLayer = /** @class */ (function (_super) {
    ...
    STKTerrainDataLayer.prototype.getFaces = function (header, uArray, vArray, heightArray, indexArray) {
        ...
        for (var i = 0; i < indexArray.length; i += 3) {
            faces.push(new Face3(indexArray[i + 0], indexArray[i + 1], indexArray[i + 2]));
        }
        return faces;
    };
    STKTerrainDataLayer.prototype.getFaceVertexUvs = function (header, uArray, vArray, heightArray, indexArray) {
        var verticesUv = uArray.reduce(function (prev, _, index) {
            prev.push(new Vector2(uArray[index] / 32767, vArray[index] / 32767));
            return prev;
        }, []);
        var faceVertexUvs = [];
        for (var i = 0; i < indexArray.length; i += 3) {
...
var STKTerrainTile = /** @class */ (function (_super) {
    ...
    STKTerrainTile.createMesh = function () {
        ...
        var geometry = new PlaneBufferGeometry(1, 1, 2, 2);
        return new Mesh(geometry, material);
    };
...
export { Map3D, Scene2D, TestScene, BingMapScene, STKTerrainScene };
//# sourceMappingURL=terra.es5.js.map
