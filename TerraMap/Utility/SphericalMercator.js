 ...
 * @returns {QtPositioning.coordinate} coordinate
 */
SphericalMercator.prototype.PixelToCartographic = function(px) {
    var ll = this.ll([px.x + MapSettings.basePlaneDimension / 2,
        px.z + MapSettings.basePlaneDimension / 2], 0);
    var meterPerPixel = this.mPerPixel(ll.latitude);
    ll.altitude = px.y * meterPerPixel;
 ...
 */
SphericalMercator.prototype.CartographicToPixel = function(coordinate) {
    var px = this.px(coordinate, 0);
 ...
 * @returns {THREE.Vector3}
 */
SphericalMercator.prototype.CartographicToCartesian = function(coordinate) {
    var coord;
    ...
    zone = LatLonToUTMXY(lat * D2R, lon * D2R, zone, coord);

    return THREE.Vector3(coord[0], coord[1], coordinate.altitude);
};
 ...
 * @returns {THREE.Vector3}
 */
SphericalMercator.prototype.PixelToCartesian = function(px) {
    return this.CartographicToCartesian(this.PixelToCartographic(px));
};
